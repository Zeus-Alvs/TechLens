...
export default function ModalEdit({ device, onClose, onSave }: ModalEditProps) {
  // Descobre se a imagem atual é um arquivo local (Base64) ou uma URL da web
  ...
  const [formData, setFormData] = useState<Device>({
    ...
    image: device.image || "",
    extraAttribute: device.extraAttribute || ""
  });

  // Converte o arquivo local do computador para String Base64
                ...
                >
                  {formData.image ? (
                    <span className="text-emerald-400 font-medium flex items-center gap-1.5">
                      ✓ Imagem detectada / Carregar nova
                    </span>
                  ) : (
                    <>
